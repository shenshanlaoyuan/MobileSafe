...
import com.shenshanlaoyuan.mobilesafe.service.ClearTaskService;
...
public class TaskManagerSettingActivity extends Activity {
	...
	private void initData() {
		...
		//通过清理进程的服务判断 是否开启
		cb_lockscreenClear.setChecked(ServiceUtils.isServiceRunning(getApplicationContext(), "com.shenshanlaoyuan.mobilesafe.service.ClearTaskService"));
	}
